        ...
        >
          ...
          >
            ...
            >
              ...
              <path d="M287.9 318.583a30.37 30.37 0 0 1-21.257-8.806L8.83 51.963C-2.078 39.225-.595 20.055 12.143 9.146c11.369-9.736 28.136-9.736 39.504 0l259.331 257.813c12.243 11.462 12.876 30.679 1.414 42.922-.456 .487-.927 .958-1 .414a30 .368 .368 .368 .368 .368 .368 .368 .368 .368 .368 .368 .368 .368 .368 .368 .368"></path>
            </svg>
          </button>
          ...
          <ul className="lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
            ...
            <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
              <Link
                href="/product"
                className={`hover:text-[#007bff] ${
                  pathname === '/product' ? 'text-[#007bff]' : 'text-gray-500'
                } block font-semibold text-[15px]`}
              >
                Product
              </Link>
        ...
        <div className="flex max-lg:ml-auto space-x-4">
          ...
          <button id="toggleOpen" className="lg:hidden">
            ...
            >
              <path
                fillRule="evenodd"
                d="M3 5a1 1 0 011 -1h12a1 -1 -1 -1zM3 -10a1 -1 -1 -1zM3 -15a1 -1 -1 -1z"
                clipRule="evenodd"
              ></path>
            </svg>
          </button>
